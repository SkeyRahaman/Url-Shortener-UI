...
const SocialButton = ({ icon, text, providerColor, isDarkMode, borderColor }) => {
    ...
    const btnStyle = {
        ...
        backgroundColor: isDarkMode ? (isHovered ? '#2d333f' : '#1a1d24') : (isHovered ? '#f8f9fa' : '#ffffff'),
    ...
    return (
        <button className="btn d-flex align-items-center justify-content-center gap-3 py-2 px-4 shadow-none w-100 mb-3"
                style={btnStyle}

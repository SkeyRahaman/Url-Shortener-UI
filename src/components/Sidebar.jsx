...
const Sidebar = ({ isOpen, isDarkMode, toggleTheme, isLogin, setIsLogin }) => {
    ...
    return (
        ...
        >
            ...
            <div className="offcanvas-body d-flex flex-column h-100 p-0 p-lg-2 mt-lg-0 mt-3">
                <div onClick={() => handleNav('/')} style={{cursor: 'pointer'}} className={`d-none d-lg-flex align-items-center mb-4 text-decoration-none ${textColor}`}>
                ...
                <ul className="nav nav-pills flex-column mb-auto gap-2">
                    ...
                    <li>
                        {isLogin ? (
                            <button 
                                onClick={() => { setIsLogin(false); handleNav('/'); }} 
                ...
                <div className="mt-auto">
                    <div className={`form-check form-switch d-lg-none mb-4 ${textColor}`}>
                        <input className="form-check-input shadow-none" type="checkbox" role="switch" id="mobileThemeSwitch" checked={isDarkMode} onChange={toggleTheme} style={{ cursor: 'pointer' }} />

...
export const MobileNavbar = ({ isDarkMode, isLogin, setIsLogin }) => {
                    ...
                    {isLogin ? (
                        <div className="dropdown">
                            <button 
                                ...
                                aria-expanded="false"
                            >
                                <img src="https://ui-avatars.com/api/?name=User&background=random" alt="User" width="35" height="35" className="rounded-circle" />
                            </button>
                            <ul className={`dropdown-menu dropdown-menu-end text-small shadow position-absolute ${isDarkMode ? 'dropdown-menu-dark' : ''}`}>
                                ...
                                <li>
                                    <button onClick={handleLogout} className="dropdown-item bg-transparent text-danger border-0 w-100 text-start">Sign out</button>
                                </li>
                            </ul>
                        </div>
                    ) : (
...
export const DesktopHeader = ({ toggleSidebar, isDarkMode, toggleTheme, isLogin, setIsLogin }) => {
                    ...
                    <>
                        ...
                        <div className="dropdown">
                            <button 
                                ...
                                aria-expanded="false"
                            >
                                <img src="https://ui-avatars.com/api/?name=User&background=random" alt="User" width="32" height="32" className="rounded-circle me-2" />
                                <span className="fs-6">User Account</span>
                            </button>
